...
NS_IMETHODIMP
nsDocShell::SetAntiDetectMaskingBrowser(const nsACString& aMaskingBrowser)
{
  mAntiDetectMaskingBrowser = aMaskingBrowser;
  return NS_OK;
}

NS_IMETHODIMP
nsDocShell::GetAntiDetectMaskingBrowser(nsACString& aMaskingBrowser)
{
  if (mAntiDetectMaskingBrowser.IsEmpty()) {
    mAntiDetectMaskingBrowser.Assign("Firefox");
    ...
    switch (mode) {
      case 1:
        rv = Preferences::GetCString("antidetect.useragent.browser",
            &mAntiDetectMaskingBrowser);
        if (!NS_SUCCEEDED(rv) || mAntiDetectMaskingBrowser.IsEmpty())
          return NS_ERROR_NOT_AVAILABLE;
        break;
      case 2:
        ...
        switch (randVal) {
          case 0:
            ...
            break;
          case 1:
            mAntiDetectMaskingBrowser.Assign("Chrome");
            break;
        }
        break;
    }
  ...
  aMaskingBrowser = mAntiDetectMaskingBrowser;
  return NS_OK;
}
