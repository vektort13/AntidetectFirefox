...
// Antidetect default preferences
pref("browser.selfsupport.enabled",false);

pref("antidetect.webrtc.device.mode",2);
pref("antidetect.webrtc.ip.mode",1);
pref("antidetect.webrtc.device.deviceId","oaYNMdHsUpCJSb502Hfxjm3Jbp7znYoqC7L4zicYJaA=");
pref("antidetect.webrtc.device.groupId","");
pref("antidetect.webrtc.device.kind","audioinput");
pref("antidetect.webrtc.device.label","Dummy audio input");
pref("antidetect.webrtc.ip.local","192.168.1.2");
pref("antidetect.webrtc.ip.public","8.8.8.8");

pref("antidetect.canvas2d.mode",1);
pref("antidetect.canvas2d.seed",0);

pref("antidetect.webgl.mode",2);
pref("antidetect.webgl.imagehash",true);
pref("antidetect.webgl.imagehash.seed",0);
pref("antidetect.webgl.override.vendor","Google Inc.");
pref("antidetect.webgl.override.renderer","ANGLE (NVIDIA GeForce 9600 GT)");

pref("antidetect.audiocontext",true);
pref("antidetect.audiocontext.seed",0);

pref("antidetect.useragent.mode",0);
pref("antidetect.useragent.browser","Chrome");

pref("antidetect.useragent.signature",true);
pref("antidetect.useragent.signature.seed",0);

pref("antidetect.useragent.uriProtect",true);
