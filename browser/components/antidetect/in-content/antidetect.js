...
function init_all() {
  ...
  gSubDialog.init();
  register_module("paneWebRTC", gWebRTCPane);
  register_module("paneCanvas2d", gCanvas2dPane);
  register_module("paneWebGL", gWebGLPane);
  register_module("paneAudioContext", gAudioContextPane);
  register_module("paneUserAgent", gUserAgentPane);
  register_module("paneResources", gResourcesPane);

  register_module("paneToBeImplemented", gToBeImplementedPane);
