...
var gIdentityHandler = {
  ...
  */
  ...
  setURI(uri) {
    ...
    whitelist = /^(?:accounts|addons|cache|config|crashes|customizing|downloads|healthreport|home|license|newaddon|permissions|preferences|privatebrowsing|rights|searchreset|sessionrestore|support|welcomeback|antidetect)(?:[?#]|$)/i;
